...
function History() {
    return (
        <section className="bg-[#1D1C18] flex flex-col items-center justify-between relative" >
            ...
            <div id='history' className="flex flex-col md:flex-row items-center justify-between px-6 md:pt-0 md:pb-0 pt-16 pb-10 w-full max-w-6xl md:min-h-[982px]">
                <div className="text-white md:text-left md:w-1/2 mb-10 md:mb-0 md:mr-10">
                    <h3 className="font-inter font-semibold lg:text-5xl text-[32px] mb-7 md:mb-4">The Dog of Ton Chain</h3>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center justify-between px-6 w-full max-w-6xl md:pt-0 md:pb-0 pt-10 pb-16  md:min-h-[982px]">
                {/* Image Section */}
                <div className="flex justify-center md:max-w-[650px] lg:max-w-[45%] my-8 md:mb-0">
                    <img src={tonjisign} alt="tonjisign" className="w-3/4 md:w-full object-contain" />
                </div>

                {/* Text Section */}
                <div className="text-white md:text-left md:max-w-[50%] lg:max-w-[55%]">
                    <p className="font-inter font-semibold lg:text-[49px] text-[32px] mb-7">An Ancient History</p>
                    <p className="font-inter font-normal mb-5 text-[16px] md:text-[25px]">
                    ...
                    <button className="bg-transparent border text-[16px] md:text-[25px] border-white text-white rounded-lg px-6 py-2 hover:bg-white hover:text-black transition">
                        BUY $TONJI
                    </button>
                </div>
            </div>
